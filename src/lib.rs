...
#[derive(Debug)]
pub struct Web3KitProcessor {
    verbose: bool,
    processed_count: usize,
}

impl Web3KitProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Web3Kit processing");
    
    let mut processor = Web3KitProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = Web3KitProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = Web3KitProcessor::new(false);
